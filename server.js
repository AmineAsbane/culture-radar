...
// ===== 18 ÉVÉNEMENTS UNIQUES AVEC IMAGES COHÉRENTES =====
const testEvents = [
    {
        id: uuidv4(),
        ...
        image_url: 'http://localhost:5000/images/visite_nocturne.jpg',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/soirée_jazz.jpg',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Street_Art_Tour_à_Belleville.jpg',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Rencontre_Littéraire.png',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Exposition_Picasso.jpg',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Cinéma_en_plein_air.jpg',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Atelier_de_Peinture.jfif',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Concert_Classique_à_Notre-Dame.JFIF',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Visite_du_Château_de_Versailles.JFIF',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Théâtre_Contemporain.JFIF',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Danse_Contemporaine.JFIF',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Photography_Walk_Paris.jpg',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Musée_d_Orsay.JFIF',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Dégustation_de_Vins.jpg',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Poésie_&_Slam_Night.png',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Atelier_de_Sculpture.jpg',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Festival_de_Musique_Électronique.JFIF',
        created_at: new Date(),
        is_published: true
    },
    {
        ...
        current_participants: 0,
        creator_id: testUser.id,
        image_url: 'http://localhost:5000/images/Visite_Catacombes_de_Paris.JFIF',
        created_at: new Date(),
        is_published: true
    }
];
